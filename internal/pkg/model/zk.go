...
func bigIntsToStrings(v interface{}) interface{} {
	...
	default:
		fmt.Printf("bigIntsToStrings unexpected type: %T\n", v)
	}
	return nil
}
...
func (z ZKInputs) ToHashGlobalData() ([]byte, error) {
  ...
  // fmt.Printf("len input root: %v\n",len(hex.EncodeToString(b))/2)
  ...
  // fmt.Printf("input l1: %v\n",hex.EncodeToString(b))
  // fmt.Printf("len input l1: %v\n",len(hex.EncodeToString(b))/2)
  ...
  // fmt.Printf("input l2: %v\n",hex.EncodeToString(b))
  // fmt.Printf("len input l2: %v\n",len(hex.EncodeToString(b))/2)
  ...
  // fmt.Printf("input fee: %v\n",hex.EncodeToString(b))
  // fmt.Printf("len input fee: %v\n",len(hex.EncodeToString(b))/2)
